...
<html>
  <head>
    ...
    <link href="<?php echo base_url('assist/css/jquery.dataTables.css'); ?>" rel="stylesheet"><!--FONT AWSOME-->
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="<?php echo base_url('index.php/Doctor/index'); ?>">Home</a>
  <a href="<?php echo base_url('index.php/Doctor/Location'); ?>">Event / Location</a>
  <a href="<?php echo base_url('index.php/Doctorlogin/Logout'); ?>">Logout</a>
</div>
