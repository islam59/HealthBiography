  ...
  <body>
    <section class="container doctor-registration">
              <div class="form-header">
                <h3>Patient / User Registration Form ! 
...
<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/Register/RegisterPatientForm'); ?>" method="post">
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <div class="form-group">
    <label for="country" class="col-sm-2 control-label">Gender<sup>*</sup></label>
    <div class="col-sm-1">
        <div class="radio">
          <label>
    ...
    <div class="col-sm-7">
      <textarea name="address" class="form-control" rows="4" style="border-radius: 0px;" placeholder="Enter Address !"></textarea>
    </div>
  </div>
  <HR/>
  ...
  <div class="form-group">
    <label for="phone" class="col-sm-2 control-label">Disses Details</label>
    <div class="col-sm-10">
      <textarea name="diesses" class="form-control" rows="4" style="border-radius: 0px;" placeholder="Enter Disses Details !"></textarea>
    </div>
  </div>
  <hr/>
  <div class="form-group" style="margin-top:2%; margin-bottom: 2%;">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <button type="submit" class="btn btn-default pull-right" style="border-radius: 0px;">Register As Patient / User !</button>
        </label>
      </div>    
    </div>
  </div>
