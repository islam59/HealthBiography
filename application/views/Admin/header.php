...
<html>
  <head>
    <title>HealthBiography !</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Bootstrap -->
    <link href="<?php echo base_url('assist/css/bootstrap.min.css'); ?>" rel="stylesheet">

    <link href="<?php echo base_url('assist/css/style-admin.css'); ?>" rel="stylesheet"><!--CUSTOMIZE STYLE-->
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="<?php echo base_url('index.php/Adminlogin/Logout'); ?>">Logout</a>
</div>
